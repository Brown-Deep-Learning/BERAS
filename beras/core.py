...
"""
This class is the heart of the assignment. It defines the constructs that you will need to rely on
to properly implement the assignment. Take your time with each of the following classes and functions
in order to ensure you understand how they work, what attributes they have, and what methods the provide.

If you are stuck or have any questions, please refer to the cheat sheet and the lecture slides.
...
class Callable(ABC):
    ...
    def forward(self, *args: Any, **kwargs: Any) -> Tensor:
        ...
        You will implement this method in each class that inherits from Callable,
        but not in the Callable class itself!
        """
        pass
